...
from .pad import (pad_brain_extraction_pipe, pad_brain_segment_pipe,
                  pad_native_to_stereo_pipe)
...
def create_full_ants_subpipes(
    ...
    if mask_file is None:
        ...
        if pad:
            pad_brain_extraction_pipe(
                seg_pipe, params, inputnode, outputnode,
    ...
    if pad and space == "native":
        ...
        pad_brain_segment_pipe(seg_pipe, params,
                               inputnode, outputnode, data_preparation_pipe,
