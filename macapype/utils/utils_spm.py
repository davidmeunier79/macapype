...
def set_spm():
    ...
    if get_matlab_command() is None:
        ...
        spm.SPMCommand.set_mlab_paths(matlab_cmd='/opt/spm12/bin/spm12-octave', use_mcr=True)
        #spm.SPMCommand.set_mlab_paths(matlab_cmd='/opt/spm12/octave', use_mcr=True)
